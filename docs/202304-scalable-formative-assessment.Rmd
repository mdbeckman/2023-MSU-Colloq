---
title: "Foundations for scalable NLP-assisted formative assessment feedback"
author: |
  | Matthew Beckman
...
1. Is your lucky number odd or even?
...
- NLP-assisted feedback for educational use:
    - previously studied for essays or long-answer tasks (see e.g., Attali, et al., 2008; Page, 1994)
    - early automated short-answer grading (ASAG) 
- We use Semantic Feature-Wise Transformation Relation Network (SFRN; Li, Tomar, & Passonneau, 2021)
    - back-translation (French & Chinese) as a means of data augmentation
    - flexible to accommodate rubric elements, expert solutions, or both

![image created with assistance of DALL·E 2 by Open AI](DALLE Robot Assist.png){width=30%}
...
![image created with assistance of DALL·E 2 by Open AI](DALLE exam.png){width=30%}
...
- Study uses extant data from prior study collected from many classes of varying size
    ...
    - perhaps conservative due to additional variability across institutions and instructors, but will be investigated further?
- Tasks & rubrics used for pilot were developed for research use, and are likely more polished than those to be encountered "in the wild"
...
- challenge labeling algorithm (EC/PC/IC "scoring"); target linguistic diversity;
- human-in-the-loop policy to optimize conditions when algorithm should defer to human input;
...
- Curse of dimensionality
    ...
    - For us, also perhaps a conflict of dimensionality due to tension between demands of classification step and clustering step
    
Field test expansion: 

- field test key aspects of project CLASSIFIES in large classes 
    - approx 13,000 students
    - two of the five institutions are recognized HSI's by US Dept of Education
- diversify item and rubric input to challenge performance

[^5]: Adapted from research aims of Project CLASSIFIES (NSF DUE-2236150)
...
Resource Page URL: <https://mdbeckman.github.io/2023-MSU-Colloq/>

# SFRN Detail (Li et al., 2021, pp. 6031)

SFRN is an end-to-end model with 3 components:

1. encode each component of a QRA triple--producing vector representations for question (Q), a possible reference (R), and the provided student answer (A)
...
3. the resulting vector representation is passed as an input to a classifier (i.e., neural network here) 
...
![DALLE 2 image given the prompt: "Roadmap for future educational research in the style of a retro travel poster"](DALLE roadmap.png){width=40%}
