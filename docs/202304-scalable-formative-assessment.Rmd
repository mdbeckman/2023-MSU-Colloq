...
![image created with assistance of DALL·E 2 by Open AI)](DALLE Robot Assist.png){width=25%}

<!-- 
DALLE: A cartoon drawing of a robot helping a college professor quickly and accurately score a large stack of student homework papers 
-->
...
![Project CLASSIFIES Schematic (NSF DUE-2236150)](Schematic.png){width=90%}
...
![Me: "oil painting of Venn diagram for three intersecting sets"; DALLE ...swing and a miss](DALLE venn diagram.png){width=30%}
...
- reliable labeling (EC/PC/IC "scoring"), across diverse student populations;
- human-in-the-loop system to optimize human input and effort for scoring;
...
- field test key aspects of project CLASSIFIES in large classes 
    ...
    - two of the five institutions have HSI designation from US Dept of Education
- diversify item and rubric input to examine system tolerance
...
![DALLE image given the prompt: "Roadmap for future educational research in the style of a retro travel poster"](DALLE roadmap.png){width=40%}
