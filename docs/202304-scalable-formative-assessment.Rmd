...
<!-- SFRN w/ 3 components: (1) encode QRA triples; (2) when relation network includes multiple QRA triples, a learned feature-wise transofmation merges them into a single relation vector; (3) passes result to a classifier (e.g., neural network) -->
